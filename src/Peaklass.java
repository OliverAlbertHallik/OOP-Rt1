...
public class Peaklass {
    public static void main(String[] args) {
        System.out.println("Bussipiletite ostmine: Müügil on piletid bussis vabadele kohtadele."); // Üldtutvustav lühiinfo käivitamisel.
        ...
        System.out.println("Kui piletid on müüdud, on edaspidi bussis vähem vabu kohti järel. Ülejäänud piletite ostmist saab jätkata, kuni küsitakse korra rohkem pileteid, kui vabu kohti järel on. Järelejäänud vabade kohtade arvu saab vaadata ka 0 piletit küsides.\n");
        Random juhuslik = new Random(); // Isend juhuarvu loomiseks.
        ...
        int ostusoov; // Muutuja, milles hoitakse kasutaja soovitud ostetavate piletite kogust.
        Scanner scan = new Scanner(System.in);
        do {
            System.out.print("Mitu piletit soovite osta?\nSisestage täisarv: ");
            ostusoov = scan.nextInt(); // Kasutajalt klaviatuurilt sisendi võtmine.
